...
public class Solution {
    ...
    public static void universalMethod(String x, String y){

    }
    public static void universalMethod(String x, String y, String z){

    }
    public static void universalMethod(float x){

    }
    public static void universalMethod(float x, float y){

    }
    public static void universalMethod(float x, float y, float z){
